...
_SYMBOL_TO_MODULE: dict[str, str] = {
    ...
    "CustomImageBackgroundWidget": "custom_background",
    "compute_cover_geometry": "custom_background",
    "import_custom_background_image": "custom_background",
    "StyledTag": "styled_tag",
    "StyledDialog": "styled_dialog",
    "DialogIconCircle": "styled_dialog",
    "create_basic_dialog": "styled_dialog",
    "create_custom_dialog": "styled_dialog",
    "ask_custom_dialog": "styled_dialog",
