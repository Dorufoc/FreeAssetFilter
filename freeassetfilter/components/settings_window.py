...
class ModernSettingsWindow(QDialog):
    ...
    def _add_player_settings(self):
        ...
        self.control_bar_audio_switch = CustomSettingItem(
            ...
            interaction_type=CustomSettingItem.SWITCH_TYPE,
            initial_value=self._get_current_setting_value("player.control_bar_show_audio", False)
        )
    ...
    def load_settings(self):
        ...
        self.current_settings = {
            ...
            "player.control_bar_show_audio": self.settings_manager.get_setting("player.control_bar_show_audio", False),
