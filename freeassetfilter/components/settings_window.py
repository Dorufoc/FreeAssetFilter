...
class ModernSettingsWindow(QDialog):
    ...
    def _add_general_settings(self):
        ...
        # 图标样式选择
        icon_styles = ["扁平", "质感", "统一", "多彩"]
        current_icon_style = self._get_current_setting_value("appearance.icon_style", 3)
        current_icon_style_text = icon_styles[current_icon_style] if current_icon_style in [0, 1, 2, 3] else icon_styles[3]
