...
# -*- coding: utf-8 -*-
"""
BaseCardDelegate - 文件卡片委托的共享基类

为 FileHorizontalCardDelegate 和 FileBlockCardDelegate
提供动画引擎、阴影渲染、颜色/字体初始化和通用绘制辅助。
"""
...
class BaseCardDelegate(QStyledItemDelegate):
    ...
    def _paint_card(self, painter, option, index, for_drag_preview=False):
        raise NotImplementedError("Subclasses must implement _paint_card")
